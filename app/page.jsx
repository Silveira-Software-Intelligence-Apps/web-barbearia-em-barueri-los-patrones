...
export default function Home() {
  ...
  return (
    <main style={{ background: '#09090f', color: '#f0f0f0' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"LocalBusiness","name":"Barbearia em barueri LOS PATRONES","description":"Estilo e cuidado profissional sob medida. Na Barbearia em barueri LOS PATRONES em Barueri, cada atendimento é uma experiência única.","telephone":"+555511950580026","address":{"@type":"PostalAddress","addressLocality":"Barueri","addressCountry":"BR"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"5","bestRating":"5","reviewCount":"52"}}' }} />
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, background: '#09090fe8', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderBottom: '1px solid #1e1e2e', height: '68px', display: 'flex', alignItems: 'center' }}>
        <div style={{ maxWidth: '1160px', margin: '0 auto', padding: '0 28px', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#f0f0f0' }}>Barbearia em barueri LOS PATRONES</div>
          </div>
          ...
          <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" className="btn-wa" style={{ padding: '10px 22px', fontSize: '0.875rem' }}>
      ...
      <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', paddingTop: '68px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '1160px', margin: '0 auto', padding: '80px 28px', width: '100%' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#14141e', border: '1px solid #e8a83833', borderRadius: '50px', padding: '6px 14px', marginBottom: '24px' }}>
            ...
            <span style={{ fontSize: '0.78rem', fontWeight: 600, color: '#e8a838', textTransform: 'uppercase', letterSpacing: '.08em' }}>barbearia · Barueri</span>
          </div>
          <h1 className="hero-title" style={{ fontSize: 'clamp(2.8rem, 7vw, 5.5rem)', fontWeight: 900, lineHeight: 1.0, marginBottom: '24px', color: '#f0f0f0', maxWidth: '700px' }}>
            Seu espaço. Seu estilo. Agende na Barbearia em barueri LOS PATRONES.
          </h1>
          <p className="hero-sub" style={{ fontSize: 'clamp(1.05rem, 2.2vw, 1.3rem)', color: '#9a9ab0', maxWidth: '540px', marginBottom: '44px', lineHeight: 1.75 }}>
            Profissionais especializados, resultado com estilo e atendimento sob medida em Barueri.
          </p>
          <div className="hero-cta" style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
            <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" className="btn-wa" style={{ fontSize: '1.05rem', padding: '17px 36px' }}>
      ...
      <section id="galeria" style={{ background: '#0e0e16', padding: '104px 28px', borderTop: '1px solid #1e1e2e' }}>
        ...
        <div className="gallery-item reveal reveal-delay-1">
          <img src="https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=600&q=80&auto=format&fit=crop" alt="Barbearia em barueri LOS PATRONES — foto 1" loading="lazy" />
        </div>
        <div className="gallery-item reveal reveal-delay-2">
          <img src="https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=600&q=80&auto=format&fit=crop" alt="Barbearia em barueri LOS PATRONES — foto 2" loading="lazy" />
        </div>
        <div className="gallery-item reveal reveal-delay-3">
          <img src="https://images.unsplash.com/photo-1605497788044-5a32c7078486?w=600&q=80&auto=format&fit=crop" alt="Barbearia em barueri LOS PATRONES — foto 3" loading="lazy" />
        </div>
        <div className="gallery-item reveal reveal-delay-1">
          <img src="https://images.unsplash.com/photo-1599351431202-1e0f0137899a?w=600&q=80&auto=format&fit=crop" alt="Barbearia em barueri LOS PATRONES — foto 4" loading="lazy" />
        </div>
        <div className="gallery-item reveal reveal-delay-2">
          <img src="https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=600&q=80&auto=format&fit=crop" alt="Barbearia em barueri LOS PATRONES — foto 5" loading="lazy" />
        </div>
        <div className="gallery-item reveal reveal-delay-3">
          <img src="https://images.unsplash.com/photo-1493256338651-d82f7acb2b38?w=600&q=80&auto=format&fit=crop" alt="Barbearia em barueri LOS PATRONES — foto 6" loading="lazy" />
        </div>
          </div>
        </div>
      </section>
      ...
      <section id="avaliacoes" style={{ background: '#0e0e16', padding: '104px 28px', borderTop: '1px solid #1e1e2e' }}>
        ...
        <div className="review-card reveal reveal-delay-1">
          ...
          <p style={{ color: '#9a9ab0', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '20px', fontStyle: 'italic' }}>"Melhor experiência que já tive. O profissional da Barbearia em barueri LOS PATRONES entendeu exatamente o que eu queria. Saí outro."</p>
        ...
        <div className="review-card reveal reveal-delay-2">
          <div style={{ color: '#e8a838', fontSize: '1rem', marginBottom: '16px', letterSpacing: '2px' }}>★★★★★</div>
          <p style={{ color: '#9a9ab0', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '20px', fontStyle: 'italic' }}>"Ambiente top, atendimento pontual e resultado impecável. Não troco por nada. Referência em Barueri."</p>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', borderTop: '1px solid #1e1e2e', paddingTop: '16px' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'linear-gradient(135deg, #e8a83844, #d4943c44)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem', flexShrink: 0 }}>👩</div>
            <div>
        ...
        <div className="review-card reveal reveal-delay-3">
          <div style={{ color: '#e8a838', fontSize: '1rem', marginBottom: '16px', letterSpacing: '2px' }}>★★★★★</div>
          <p style={{ color: '#9a9ab0', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '20px', fontStyle: 'italic' }}>"5★ — Agendei pelo WhatsApp, fui atendido na hora. Profissional, moderno e com estilo. Voltarei sempre."</p>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', borderTop: '1px solid #1e1e2e', paddingTop: '16px' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'linear-gradient(135deg, #e8a83844, #d4943c44)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem', flexShrink: 0 }}>🧑‍🎨</div>
            <div>
        ...
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            ...
            <p style={{ color: '#9a9ab0', maxWidth: '460px', margin: '0 auto', fontSize: '1rem', lineHeight: 1.7 }}>
              Agende pelo WhatsApp e garanta seu horário. Atendemos em Barueri e região.
            </p>
          </div>
          <form onSubmit={(e) => {
            e.preventDefault();
            ...
            const text = encodeURIComponent('Olá Barbearia em barueri LOS PATRONES! Vi o site e gostaria de um orçamento. Nome: ' + n + ', Tel: ' + f + (m ? ', Mensagem: ' + m : ''));
            window.open('https://wa.me/555511950580026' + ('5511950580026' ? '?text=' + text : ''), '_blank');
      ...
      <section id="servicos" style={{ padding: '104px 28px' }}>
        ...
        <div className="card reveal reveal-delay-1">
          ...
          <p style={{ fontSize: '0.875rem', color: '#9a9ab0', lineHeight: 1.7 }}>Estilo sob medida em Barueri</p>
        </div>
        ...
        <div className="card reveal reveal-delay-3">
          ...
          <div style={{ textAlign: 'center', marginTop: '48px' }}>
            <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" className="btn-wa">Falar sobre um serviço →</a>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#0e0e16', borderBottom: '1px solid #1e1e2e' }}>
        ...
        <div className="stat-card reveal">
          ...
          <div style={{ width: '32px', height: '2px', background: '#e8a838', margin: '12px auto', borderRadius: '2px' }} />
          <div style={{ fontSize: '0.875rem', color: '#9a9ab0' }}>Google (62 avaliações)</div>
        </div>
        </div>
      </section>
      <div className="divider-gradient" />
        ...
        <div style={{ maxWidth: '1160px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '72px', alignItems: 'center' }} className="grid-2-responsive">
          <div className="reveal">
            ...
            <p style={{ color: '#9a9ab0', lineHeight: 1.85, fontSize: '1.05rem', marginBottom: '32px' }}>
              Referência em barbearia em Barueri, a <strong style={{ color: '#f0f0f0' }}>Barbearia em barueri LOS PATRONES</strong> combina estilo e cuidado profissional em cada atendimento. Nosso espaço foi pensado para proporcionar uma experiência única, com profissionais atualizados e apaixonados pelo que fazem. Com avaliação 5★ no Google, somos referência para quem valoriza qualidade.
            </p>
            ...
            <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" className="btn-wa">Agendar Agora →</a>
          </div>
          <div className="reveal reveal-delay-2" style={{ position: 'relative' }}>
            <div style={{ borderRadius: '24px', overflow: 'hidden', height: '520px', boxShadow: '0 32px 64px #09090f99' }}>
              <img src="https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=900&q=80&auto=format&fit=crop" alt="Barbearia em barueri LOS PATRONES" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" />
      ...
      <section id="faq" style={{ padding: '104px 28px' }}>
        ...
        <div className="faq-item reveal reveal-delay-1">
          ...
          <div className="faq-answer" style={{ display: 'none' }}>Recomendamos agendar pelo WhatsApp (5511950580026) para garantir horário, mas aceitamos sem agendamento.</div>
        </div>
        ...
        <div className="faq-item reveal reveal-delay-1">
          <button className="faq-question" onClick={(e) => {
            ...
            <span>Onde fica a Barbearia em barueri LOS PATRONES?</span>
            <span className="faq-icon">+</span>
          </button>
          <div className="faq-answer" style={{ display: 'none' }}>Estamos em R. Duque de Caxias, 177 - Vila Srg. Jose de Paula, Barueri - SP, 06401-010, Brasil, Vila Sargento Jose de Paula, Barueri. Venha nos visitar ou entre em contato pelo WhatsApp para mais informações.</div>
        </div>
          </div>
          <div style={{ textAlign: 'center', marginTop: '48px' }}>
            <p style={{ color: '#9a9ab0', marginBottom: '20px', fontSize: '0.95rem' }}>Sua dúvida não está aqui?</p>
            <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" className="btn-outline">Perguntar pelo WhatsApp</a>
          </div>
        </div>
      </section>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', padding: '120px 28px' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '680px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 900, lineHeight: 1.1, marginBottom: '20px', color: '#f0f0f0' }}>
            Fale com a <span style={{ color: '#e8a838' }}>Barbearia em barueri LOS PATRONES</span><br />agora mesmo
          </h2>
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" className="btn-wa" style={{ fontSize: '1.1rem', padding: '18px 44px' }}>
      ...
      <footer style={{ background: '#09090f', borderTop: '1px solid #1e1e2e', padding: '64px 28px 32px' }}>
        <div style={{ maxWidth: '1160px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '48px', marginBottom: '48px', paddingBottom: '48px', borderBottom: '1px solid #1e1e2e' }} className="grid-responsive">
            <div>
              ...
              <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
                <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#25d36622', border: '1px solid #25d36644', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#25d366', fontSize: '0.9rem' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                <a href="https://wa.me/555511950580026?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20mais%20informações." target="_blank" style={{ color: '#9a9ab0', fontSize: '0.875rem', display: 'flex', alignItems: 'center', gap: '8px' }}><span style={{ color: '#25d366' }}>📱</span> 5511950580026</a>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
            <p style={{ color: '#9a9ab0', fontSize: '0.8rem' }}>© 2026 Barbearia em barueri LOS PATRONES. Todos os direitos reservados.</p>
